...
### lib
Contains two main files **aggregator.tsx** and **prepareData.tsx** that request for the data feed and prepare the data for the view (frontend) respectively.
...
```
This `class` houses the mechanism that fetches and aggregates the data feeds. Lets digest it.
